...
7   La ligne rouge reasonable
8   La ligne rouge  quality
9   La ligne rouge    tasty
10  La ligne rouge     meat
# ... with 10 more rows
```
...
```r
get_sentiments("afinn")   # Scores de -5 à +5
get_sentiments("bing")    # Positif/Négatif
get_sentiments("nrc")     # 8 émotions + pos/neg
```
...
## Données textuelles (et méthodes quantitatives pour les analyser) pas sans limites :no_entry_sign:
