...
- Créées par vous pour des besoins spécifiques

---

## Anatomie d'une fonction {.smaller}
...
## Limites à connaître {transition="none"}
...
## Préparation des données pour le topic modeling {transition="none"}
